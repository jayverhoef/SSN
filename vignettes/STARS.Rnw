...
% cd '/mnt/Hitachi2GB/00NMML/ActiveRPack/SSN_package/SSN/vignettes'
...
\begin{center}
	\href{https://www.fs.usda.gov/rm/boise/AWAE/projects/SSN_STARS/latest_releases.html}{\Large STARS}
\end{center}
