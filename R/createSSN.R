...
#	}
	...
	if(n_networks > 1)
	{
        ...
        ##set up storage for the edges data to be written by readOGR
	...
	## Change the working directory back in case the path was specified as relative.
        ## We only needed it for the writeSpatialShapes calls
	setwd(old_wd)
